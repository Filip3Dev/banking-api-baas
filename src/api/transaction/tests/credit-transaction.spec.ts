...
describe('Test CreditTransaction use case', () => {
  it('success when trying to create an credit transaction when account exists', async () => {
  ...
  it('success when trying to create an credit transaction when account not exists', async () => {
  ...
  it('fails when trying to create an credit transaction when account is blocked', async () => {
    const account = await makeAccount()
